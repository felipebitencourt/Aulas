...
if ($form) {
    ...
    $resultado = selectSQLUnico("SELECT login FROM colaboradores_criptografados WHERE login='$login'");
    if (empty($resultado)) {
        iduSQL("INSERT INTO colaboradores_criptografados (nome, apelido, nif, login, senha) VALUES ('$nome', '$apelido', '$nif', '$login', '$senha')");
    ...
    <main class="container">
        ...
        <div class="row">
            <div class="col-8 m-auto border border-danger text-center rounded-5 py-5">
                ...
                <br><br>
                <a href="index.php" class="m-auto"><button class="btn btn-danger">Voltar</button></a>
            </div>
        </div>
    </main>
