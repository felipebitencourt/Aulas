...
if($form){
    ...
    $id =  $_GET["editar"];
    $noticia_especifica = selectSQLUnico("SELECT * FROM noticias WHERE id=$id");
    $form_2 = !empty($_GET["titulo"]) && !empty($_GET["imagem"]) && !empty($_GET["texto"]);
    ...
    if($form_2){
        ...
        iduSQL("UPDATE noticias SET titulo='$titulo', imagem='$imagem', texto='$texto' WHERE id=$id");
    ...
    <main class="container text-center py-5">
        ...
        <form class="row">
            ...
            <div class="col-12 mt-3">
                ...
                <textarea name="texto" id="texto" rows="25" cols="150"><?= $noticia_especifica["texto"]; ?></textarea>
