...
<body>
    ...
    <main class="container-fluid text-center px-5">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <button class="btn btn-outline-success my-3"><a class="text-decoration-none text-white" href="novo_empreendimento.php">Novo Empreendimento</a></button>
                    ...
                    <?php foreach($empreendimentos as $e): ?>
                        ...
                        <tr>
                            ...
                            <?php for($i=1; $i <= 4; $i+=1): ?>
                                ...
                                <td>
                                    <img src="<?= $e["imagem_$i"]; ?>" alt="<?= $e["imagem_$i"]; ?>" width="200">
                                </td>
                            ...
                            <td>
                                <button class="btn btn-outline-warning mb-2"><a class="text-decoration-none text-white" href="empreendimentos_editar.php?editar=<?= $e["id"] ;?>">Editar</a></button>
                                <button class="btn btn-outline-danger"><a class="text-decoration-none text-white" href="empreendimentos_apagar.php?apagar=<?= $e["id"] ;?>">Apagar</a></button>
                            </td>
