...
$form = !empty($_GET["titulo"]) && !empty($_GET["imagem_1"]) && !empty($_GET["imagem_2"]) && !empty($_GET["imagem_3"]) && !empty($_GET["imagem_4"]) && !empty($_GET["texto"]);
        ...
        <form class="row">
            ...
            <?php for($i=1; $i <= 4; $i+=1): ?>
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="imagem_<?=$i;?>" id="imagem_<?=$i;?>">
            ...
            <div class="col-12 mt-3">
                ...
                <textarea name="texto" id="texto" rows="25" cols="150"></textarea>
