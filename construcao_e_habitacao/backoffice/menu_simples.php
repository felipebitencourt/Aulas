...
if($form){
    $nome_da_pagina = $_GET["pagina"];
    $menu_simples = getMenuPeloNome($nome_da_pagina);
    ...
    if($form_2){
        ...
        header("Location: menu_simples.php?pagina=$nome_da_pagina");
        exit();
    }
    ...
    <main class="container text-center py-5">
        ...
        <?php else: ?>
            ...
            <form class="row">
                ...
                <input type="hidden" name="pagina" value="<?= $nome_da_pagina; ?>">

                <div class="col-12 mt-5">

                    <textarea name="texto" id="texto" rows="25" cols="150"> <?= $menu_simples["texto"];?></textarea>
