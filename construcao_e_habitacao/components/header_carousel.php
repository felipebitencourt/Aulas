                    ...
                    <div class="container-fluid text-uppercase">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav me-auto mb-lg-0 navbar_header align-items-start mt-sm-3">
                                ...
                                <li class="nav-item pe-3"><a class="nav-link p-0 pb-3" href="quem_somos.php">Quem Somos</a></li>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner"> <br>
                        ...
                        <?php foreach($carousel as $i => $c): ?>
                            ...
                            <div class="carousel-item <?= ($i == 0) ? "active" : ""; ?> sombra_carousel">
                                <img src="<?= $c["imagem"]; ?>" class="w-100" alt="<?= $c["imagem"]; ?>">
                            </div>
